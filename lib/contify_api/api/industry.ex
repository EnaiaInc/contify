...
defmodule ContifyAPI.Api.Industry do
  @moduledoc """
  ...
  @doc """
  Industry list
  Returns a list of industries for the authenticated user
  ...
  """
  @spec industries_get(Tesla.Env.client(), keyword()) ::
          {:ok, ContifyAPI.Model.IndustriesGet200Response.t()}
          | {:ok, ContifyAPI.Model.Error.t()}
          | {:ok, String.t()}
          | {:error, Tesla.Env.t()}
  def industries_get(connection, _opts \\ []) do
    request =
      %{}
      |> method(:get)
      |> url("/industries")
